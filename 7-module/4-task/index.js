...
//     this.elem = document.createElement('div')
//     this.elem.classList.add('slider')
//     this.elem.addEventListener('pointerdown', ev => this.onClick(event))
...
//     }));
//     this.moveThumb()
//     this.elem.addEventListener('pointermove', ev => this.moveThumb(event))
//   }
...
//     document.addEventListener('pointermove', ev => this.moveThumb(event))
//     document.addEventListener('pointerup', ev => this.onMouseUp(event))
//   }
...
//     document.removeEventListener('pointerup', ev => this.onMouseUp(mouseEvent))
